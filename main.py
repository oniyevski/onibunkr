...
parser = argparse.ArgumentParser(description="You can learn how to use arguments and what they do here.", formatter_class=argparse.ArgumentDefaultsHelpFormatter, prog='onibunkr')
...
{Fore.LIGHTCYAN_EX}\____/_/ /_/_/_.___/\__,_/_/ /_/_/|_/_/     {Back.LIGHTCYAN_EX}{Fore.BLACK} v1.0 {Fore.RESET}{Back.RESET}
...
try:
    ...
    if getAlbumCheckElement != []:
        ...
        try:
            ...
            pass
        path = os.path.join("albums", config["album_name"])  
        try:
            os.mkdir(path) 
        except:
